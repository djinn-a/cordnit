...
export default function MegaMenu({ content, solutions, isOpen, onLinkClick }: Readonly<MegaMenuProps>) {
  return (
    <div className={`absolute top-20 left-0 w-full transition-all duration-300 ease-in-out border-t border-white/5 shadow-2xl bg-gradient-to-r from-primary to-surface-darker ${isOpen ? 'opacity-100 visible pointer-events-auto' : 'opacity-0 invisible pointer-events-none'}`}>
