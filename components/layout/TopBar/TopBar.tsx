...
import { useNewsletterModal } from '../../features/newsletter/NewsletterModalProvider';

export default function TopBar() {
  const { openModal } = useNewsletterModal();

  return (
    <div className="w-full bg-primary text-white py-1.5 px-4 sm:px-6 lg:px-8 z-[60] relative">
