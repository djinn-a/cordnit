    ...
    <section className="w-full pt-2 pb-16 lg:pt-4 lg:pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl 2xl:max-w-container-xl 3xl:max-w-container-2xl mx-auto bg-white">
      <div className="flex flex-col lg:flex-row justify-between gap-6 lg:gap-16 items-center">
        ...
        <div className="w-full lg:w-[42%] flex flex-col items-center md:items-start text-center md:text-left">
          <h4 className="text-[#2251ff] font-bold text-[10px] tracking-widest uppercase mb-4">
            CONTACT US
          </h4>
          ...
          <p className="text-gray-600 text-[15px] md:text-base leading-relaxed font-normal mb-2 lg:mb-0">
        ...
        <div className="w-full lg:w-[55%] relative flex justify-end mt-2 lg:mt-0">
          <div className="relative w-full h-[450px] md:h-[500px] lg:h-[420px] xl:h-[460px] rounded-[32px] overflow-hidden shadow-xl">
            {/* Background Image */}
