...
export default function InsightsSection() {
  ...
  return (
    <section className="w-full pt-8 pb-8 sm:py-20 px-4 sm:px-6 lg:px-8 max-w-7xl 2xl:max-w-container-xl 3xl:max-w-container-2xl mx-auto bg-white overflow-hidden">
      {/* Header */}
      <div className="mb-12">
        <h3 className="text-[#2251ff] font-bold text-section-subtitle tracking-[0.15em] uppercase mb-4">
        ...
        {insights.map((item) => (
          ...
          >
            ...
            <div className="relative z-10 p-6 bg-black/40 backdrop-blur-md border-t border-white/10">
              ...
              <div className="flex items-center text-[#2251ff] text-sm font-medium">
