  ...
  return (
    <div className="flex flex-col p-3 md:p-8 bg-grad-3 border border-border-card rounded-lg backdrop-blur-[20px]">
      <div className="flex flex-col gap-3">
        ...
        <Link 
          href={ctaLink}
          className="inline-flex items-center gap-1 text-primary text-[10px] font-semibold leading-relaxed md:text-sm md:leading-5 hover:text-primary-hover transition-colors mt-1"
        >
          {ctaLabel}
