    ...
    <NewsletterModalContext.Provider value={{ isOpen, openModal, closeModal }}>
      ...
      {isOpen && (
        ...
        >
          ...
          <button 
            onClick={closeModal}
            className="absolute top-6 right-6 z-50 p-2 text-white/70 hover:text-white bg-white/10 hover:bg-white/20 rounded-full backdrop-blur-md transition-colors"
          ...
          {/* Card Container */}
          <div className="relative z-10 w-full max-w-[540px] mx-4 p-8 sm:p-12 rounded-3xl bg-[#0a1122]/60 backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.4)] min-h-[460px] flex flex-col justify-center my-8">
