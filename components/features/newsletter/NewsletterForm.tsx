    ...
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden bg-gradient-newsletter backdrop-blur-[100px]">
      ...
      <div className="absolute inset-0 z-0 opacity-20 pointer-events-none">
        <svg viewBox="0 0 100 100" preserveAspectRatio="none" className="w-full h-full">
          ...
          <path d="M0,60 Q25,35 50,60 T100,60 L100,100 L0,100 Z" fill="none" stroke="var(--color-primary)" strokeWidth="0.5" className="opacity-20" />
          <path d="M0,70 Q25,45 50,70 T100,70 L100,100 L0,100 Z" fill="none" stroke="var(--color-primary)" strokeWidth="0.5" className="opacity-10" />
          <path d="M0,40 Q25,15 50,40 T100,40 L100,0 L0,0 Z" fill="none" stroke="var(--color-primary)" strokeWidth="0.5" className="opacity-30" />
          <path d="M0,30 Q25,5 50,30 T100,30 L100,0 L0,0 Z" fill="none" stroke="var(--color-primary)" strokeWidth="0.5" className="opacity-20" />
        </svg>
      </div>

      <div className="absolute -bottom-[20%] -left-[10%] w-[50%] h-[50%] rounded-full bg-primary/10 blur-[120px] pointer-events-none"></div>
