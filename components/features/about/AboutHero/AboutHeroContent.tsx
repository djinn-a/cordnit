...
export default function AboutHeroContent({
  ...
  return (
    <div className="absolute bottom-4 sm:bottom-12 left-4 sm:left-12 w-[calc(100%-2rem)] sm:w-auto md:w-[480px] lg:w-[560px] bg-surface/30 sm:bg-surface/20 backdrop-blur-md p-6 sm:py-6 px-8 rounded-hero border border-surface/20 shadow-2xl">
