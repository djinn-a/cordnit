...
export function DataSecurityOverview({ data }: Readonly<DataSecurityOverviewProps>) {
  ...
  const gapClass = data.processCards ? "gap-[24px] md:gap-space-64" : "gap-[24px] md:gap-space-80";
  ...
  return (
    <section className={`w-full flex flex-col ${gapClass}`}>
      ...
      {data.processCards && (
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-[12px] md:gap-space-24 w-full">
