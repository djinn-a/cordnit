    ...
    <section className={`w-full flex flex-col ${gapClass}`}>
      ...
      {data.processCards && (
        data.variant === "cloud-configuration" ? (
          <div className="flex flex-col w-full md:border md:border-[var(--border,#DCE6F5)] md:rounded-3xl py-space-20 md:p-space-40 mt-space-12 md:mt-space-24">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center w-full mb-space-16 md:mb-space-24 gap-space-12 md:gap-0 border-b border-border-subtle md:border-none pb-space-12 md:pb-0">
              <span className="text-[10px] md:text-[12px] leading-[14px] md:leading-[16px] text-ink-muted uppercase font-mulish tracking-wider">
              ...
              <div className="w-fit bg-primary/10 md:bg-transparent rounded-md md:rounded-none px-space-10 py-space-4 md:p-0 flex items-center justify-center">
                <span className="text-[10px] md:text-[12px] leading-[14px] md:leading-[16px] text-brand-primary uppercase font-mulish tracking-widest md:tracking-normal">
                  {data.processSectionInfo?.headerRight}
                </span>
              </div>
            </div>
            
            <div className="flex flex-row flex-wrap justify-center md:grid md:grid-cols-3 gap-[11px] md:gap-space-16 w-full mb-space-24">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between w-full border-t border-border-subtle md:border-[var(--border,#DCE6F5)] pt-space-16 md:pt-space-24 gap-space-16 md:gap-0">
              ...
              <div className="w-fit bg-primary/10 md:bg-transparent rounded-md md:rounded-none px-space-10 py-space-4 md:p-0 flex items-center justify-center">
                <span className="text-[10px] md:text-[12px] leading-[14px] md:leading-[16px] text-brand-primary uppercase font-mulish tracking-wider md:tracking-normal">
