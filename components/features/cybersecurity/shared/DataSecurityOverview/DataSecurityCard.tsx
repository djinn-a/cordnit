...
export function DataSecurityCard({ stepNumber, title, description }: Readonly<DataSecurityCardProps>) {
  return (
    <div className="bg-white border border-border-card rounded-card-sm shadow-help-card w-full md:w-space-51 h-full md:min-h-space-59 p-space-16 md:p-space-21 flex flex-col justify-start items-start">
