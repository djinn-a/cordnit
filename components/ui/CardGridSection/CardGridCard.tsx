...
export default function CardGridCard({ card }: CardGridCardProps) {
  return (
    <Link
      href={card.href}
      className={cn(
        "group relative flex flex-col h-full w-full max-w-[286px] rounded-card-grid border px-space-16 pb-space-16 pt-space-20 lg:px-space-24 lg:pt-[31px] lg:pb-[31px] transition-all duration-300 mx-auto",
