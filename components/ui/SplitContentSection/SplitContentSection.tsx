  ...
  return (
    <section className="w-full">
      <div className="mx-auto flex flex-col lg:flex-row items-start justify-between gap-space-40 lg:gap-space-64">
        ...
        {/* Content Column */}
        <div className="w-full lg:w-[704px] flex flex-col lg:items-end flex-shrink-0">
          <div className="w-full max-w-[587px] flex flex-col gap-space-20 mx-auto lg:mx-0">
            <p className="text-page-hero-eyebrow text-brand-primary">
              {data.eyebrow}
            </p>
            <h2 className="text-split-section-title text-ink">
              {data.title}
            </h2>
            <div className="flex flex-col gap-space-24">
              {data.paragraphs.map((p, index) => (
                <p
                  key={index}
                  className="text-page-hero-subtitle text-ink-muted"
                >
                  {p}
                </p>
              ))}
