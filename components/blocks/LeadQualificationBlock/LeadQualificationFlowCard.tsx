...
export default function LeadQualificationFlowCard({ step, isGrid }: Readonly<LeadQualificationFlowCardProps>) {
  const gridCard = (
    <div className={cn(
      "flex flex-col rounded-2xl p-space-12 md:p-space-24 border w-full h-full justify-between gap-space-12 md:gap-space-16",
      step.theme === "blue" 
      ...
      <div className="flex flex-col gap-space-4">
        <span className={cn(
          "text-[10px] md:text-[12px] font-extrabold md:font-normal leading-space-16 uppercase font-mulish",
          step.theme === "blue" ? "text-white/80" : "text-brand-primary"
        )}>
          {step.numberStr}
        </span>
        <h3 className={cn(
          "text-[14px] md:text-base font-extrabold md:font-bold uppercase font-mulish",
      ...
      <p className={cn(
        "text-[12px] md:text-sm font-normal font-mulish",
  ...
  const rowCard = !step.numberStr ? (
    <div className="hidden md:flex bg-white rounded-2xl p-space-16 md:p-space-24 border border-border-card shadow-sm w-full items-center justify-between gap-space-16">
    ...
    <div className="hidden md:flex bg-white rounded-2xl p-space-24 border border-border-card shadow-sm w-full">
