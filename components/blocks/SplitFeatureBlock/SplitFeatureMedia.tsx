...
export function SplitFeatureMedia({
  ...
  return (
    <div className={`flex flex-col md:w-full lg:flex-1 md:ml-0 md:p-space-32 bg-primary-pale md:bg-brand-pale md:rounded-4xl ${
      mediaStyle === "numbered-steps" 
        ? "w-full p-space-20 rounded-card-sm" 
        : "-mx-4 px-4 py-space-20 rounded-none"
    }`}>
      ...
      <div className="flex flex-col gap-space-12 md:gap-space-16 relative items-center w-full">
        {cards.map((card, index) => (
          <React.Fragment key={card.title}>
            <div
              className={`w-full bg-white md:bg-surface p-space-16 md:p-space-16 flex items-start gap-space-16 md:gap-space-16 shadow-help-card ${
