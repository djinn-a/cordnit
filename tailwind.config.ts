  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        ...
        "card-tag": ["10px", { fontWeight: "400", lineHeight: "1.5" }],
        "extra-title-desktop": ["20px", { fontWeight: "600", lineHeight: "1.2" }],
        "mobile-cta-2": ["10px", { fontWeight: "600", lineHeight: "14px", letterSpacing: "0px" }],
        "mobile-tag": ["10px", { fontWeight: "400", lineHeight: "14px", letterSpacing: "0.6px" }],
        "mobile-heading-1": ["20px", { fontWeight: "700", lineHeight: "28px", letterSpacing: "0px" }],
        "mobile-body-1": ["14px", { fontWeight: "400", lineHeight: "22px", letterSpacing: "0px" }],
        "mobile-cta-1": ["14px", { fontWeight: "600", lineHeight: "22px", letterSpacing: "0px" }],
        "mobile-subhead": ["10px", { fontWeight: "800", lineHeight: "16px", letterSpacing: "1px" }],
        "mobile-heading-1-eb": ["20px", { fontWeight: "800", lineHeight: "28px", letterSpacing: "0px" }],
        "mobile-heading-5": ["14px", { fontWeight: "700", lineHeight: "22px", letterSpacing: "0px" }],
        "mobile-body-4": ["12px", { fontWeight: "400", lineHeight: "16px", letterSpacing: "0px" }],
        "mobile-heading-2": ["16px", { fontWeight: "600", lineHeight: "24px", letterSpacing: "0px" }],
        "mobile-heading-4": ["24px", { fontWeight: "800", lineHeight: "34px", letterSpacing: "0px" }],
        "mobile-footer-heading": ["10px", { fontWeight: "700", lineHeight: "14px", letterSpacing: "1px" }],
      },
    },
  },
  plugins: [],
